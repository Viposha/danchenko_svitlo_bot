...
def test_write_to_db_command(create_read_users_from_database_function):
	command = """ 
...
def test_read_from_db_client(crete_user_in_database_func):
	id = 1
	username = 'Viposha'
	chat_id = 123456
	crete_user_in_database_func(id, username, chat_id)
